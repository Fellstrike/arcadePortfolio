...
<<<<<<< Updated upstream
    ...
    pixelatedImage.image(nilsPic, width * 0.3, height * 0.1, width * 0.45, height * 0.45);
...
=======
    ...
    for (let x = width *0.5; x < width * 0.5; x += pixelation_level) {
      for (let y = height * 0.15; y < height * 0.35; y += pixelation_level) {
